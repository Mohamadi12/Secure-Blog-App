...
const LoginPage = async () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-gray-100 to-gray-200">
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-lg shadow-lg">
          <div className="space-y-2 text-center">
            <h1 className="text-3xl font-bold tracking-tight text-gary-900">
              Login
            </h1>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link
                href={"/register"}
                className="text-black ml-2 font-semibold hover:text-black"
              >
                Register
              </Link>
            </p>
      ...
      <div className="hidden bg-red-300 md:flex w-1/2 p-12 items-center justify-center relative">
        <div className="max-w-lg space-y-6 text-white z-10">
          ...
          <p className="text-right text-lg text-black font-bold">- Mohamdi</p>
        </div>
